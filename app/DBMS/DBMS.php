...
abstract class DBMS
{
     ...
     * @return array|bool Returns all rows selected or outputted by Database query or false on empty
     */
    abstract public static function fetch_all($is_assoc = true): array|bool;
